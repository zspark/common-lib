...
public:
  ...
  void SetDefaultColor(ConForeColor::color defaultColor,ConBackColor::color backgroundColor);
  void SetInfoColor(ConForeColor::color defaultColor,ConBackColor::color backgroundColor);
  void SetWarningColor(ConForeColor::color defaultColor,ConBackColor::color backgroundColor);
  void SetErrorColor(ConForeColor::color defaultColor,ConBackColor::color backgroundColor);
  void SetInputColor(ConForeColor::color defaultColor,ConBackColor::color backgroundColor);
